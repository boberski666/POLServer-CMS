...
INSERT INTO `characters` (`char_id`, `char_name`, `char_title`, `char_race`, `char_body`, `char_female`, `char_nototitle`, `char_bodyhue`, `char_public`) VALUES
(950, 'Rissica', '', 'Elf', '606', 1, 'Rissica', 33673, 0),
(9051, 'Kiba', '', 'Human', '401', 1, 'Kiba', 33770, 0);
