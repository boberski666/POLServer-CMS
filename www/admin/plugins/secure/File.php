<?php
if( !AdminUtils::isUserLogged() ) die();

define('FM_EMBED', true);
define('FM_SHOW_HIDDEN', true);
define('FM_ROOT_PATH', ROOT_ADMIN_DIR.'../');
define('FM_ROOT_URL', DOMAIN);
define('FM_SELF_URL ', DOMAIN.'admin/rawsecure/file/');
/**
