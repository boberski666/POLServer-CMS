...
class MainController {
    ...
    public function chooseAction() {
        $controllerClass = ControllerMapping::find($this->route->getController(), $this->route->getSubdomain());
        ...
        if (DEBUG) {
            ...
            $this->display->addParameter('subdomain_log', $this->route->getSubdomain());
        }
    }
